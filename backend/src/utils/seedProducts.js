...
const sampleProducts = [
  {
    ...
    description:
      "High-performance 18V cordless drill with 2 batteries, charger, and premium carrying case. Perfect for professionals and DIY enthusiasts.",
    price: 129.99,
  ...
  },
  {
    ...
    description:
      "Premium hammer set with ergonomic handles. Includes claw hammer, ball peen hammer, and rubber mallet.",
    price: 49.99,
  ...
  },
  {
    ...
    description:
      "Complete solar panel system with charge controller, inverter, and installation hardware. Perfect for RVs, boats, and off-grid applications.",
    price: 299.99,
  ...
  },
  {
    ...
    description:
      "Professional-grade digital multimeter with auto-ranging, True RMS, and data logging capabilities. Essential for electrical work.",
    price: 89.99,
    categoryId: 2,
    stockQuantity: 30,
  ...
  },
  {
    ...
    description:
      "Cut-resistant work gloves with reinforced palms and fingers. EN388 certified for maximum protection in industrial environments.",
    price: 19.99,
  ...
  },
  {
    ...
    description:
      "ANSI-approved safety helmet with built-in LED headlamp and adjustable suspension system. Lightweight and comfortable for all-day wear.",
    price: 39.99,
    categoryId: 3,
    stockQuantity: 50,
    sku: "HELMET-LED-ANSI",
  ...
  },
  {
    ...
    description:
      "45-piece precision screwdriver set with magnetic tips and rotating caps. Includes Phillips, flathead, Torx, and hex bits.",
    price: 24.99,
    categoryId: 1,
    stockQuantity: 60,
  ...
  },
  {
    ...
    description:
      "Portable LED work light with adjustable stand and 360-degree rotation. IP65 waterproof rating for outdoor use.",
    price: 79.99,
    categoryId: 2,
    stockQuantity: 35,
    sku: "LED-WORK-50W",
...
async function seedProducts() {
  try {
    ...
    if (existingProducts > 0) {
      console.log(
        `⚠️  Found ${existingProducts} existing products. Skipping seed.`
      );
    ...
    for (const productData of sampleProducts) {
      try {
        ...
        if (!category) {
          console.log(
            `⚠️  Category ${productData.categoryId} not found for product ${productData.title}`
          );
        ...
        console.error(
          `❌ Failed to create ${productData.title}:`,
          error.message
        );
      }
    }
    ...
    console.log(
      `🎉 Product seeding completed! Total products: ${totalProducts}`
    );
  } catch (error) {
